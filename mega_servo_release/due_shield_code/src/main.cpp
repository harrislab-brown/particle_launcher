...
int cameraTriggerDelay = 30; // Delay in milliseconds
...
int servoRestPosition = 2; // Servo position when not triggered
int servoReleasePosition = 17; // Servo position to release the particle
